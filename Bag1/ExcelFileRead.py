...
class excelfileread():
    ...
    def excelfilereadhandling(self):
        readdata=openpyxl.load_workbook("C:\\Users\\sathishkumar\\PycharmProjects\\SepPythonBasiconline\\Input\\inputdata.xlsx")

        #writedata = openpyxl.load_workbook("C:\\Users\\sathishkumar\\PycharmProjects\\SepPythonBasiconline\\Input\\inputdata.xlsx","w")
        ...
        for eachrow in range(1,maximumrow+1):
            for eachcolumn in range(1,maximumcolumn+1):
                ...
                print(cell)
            print("\n")
        excelopenoutput.save(
                "C:\\Users\\sathishkumar\\PycharmProjects\\SepPythonBasiconline\\Input\\writedata.xlsx")
